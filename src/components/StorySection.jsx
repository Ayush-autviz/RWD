...
const StorySection = () => {
  ...
  const [comments, setComments] = useState([
    ...
    },
    {
      ...
      content: 'Rutrum enim commodo est tristique vitae ut porta euismod cras. Id quis at donec duis scelerisque. Diam magnis adipiscing tellus sapien diam neque porta nullam lectus.',
      time: '2 days ago',
      clap: 4,
      heart: 3,
      tears_of_joy: 5
    },
    {
      ...
      content: 'Lectus quis ac quis lectus elit. Dolor tortor eu tristique malesuada. Quis dictumst nulla vitae velit nisi.',
      time: '5 days ago',
      clap: 4,
      heart: 3,
      tears_of_joy: 5
      ...
      <div className="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
        <div className="w-full flex-col justify-start items-start lg:gap-3 gap-3 inline-flex">
          <div className="flex flex-row items-center w-full gap-4">
            <h2 className="text-[#4db510] text-3xl font-bold leading-normal">Stories Unfold</h2>
            <div
              className={`w-8 h-8 rounded-full bg-[#4db510] flex justify-center items-center transition-transform duration-300 ${isOpen ? 'rotate-45' : 'rotate-0'}`}
              onClick={handlePlusClick}
            >
              <img className="w-5 h-5 filter-white" src="plus.png" alt="plus icon" />
            </div>
          </div>
          <div
            className={`w-full flex-col justify-start items-start gap-5 mt-3 flex overflow-hidden transition-all duration-300 ease-in-out ${isOpen ? 'max-h-[300px] opacity-100 mb-3' : 'max-h-0 opacity-0'}`}
          >
            <textarea
            ...
            {comments.map((comment) => (
              ...
              >
                <div className="w-full flex-col justify-start items-start gap-3.5 flex">
                  ...
                  <p className="text-gray-800 text-sm font-normal leading-snug">
                    ...
                    {comment.content.length > 100 && (
                      ...
                      >
                        {expandedComments[comment.id] ? (
                          <span className="underline font-semibold text-[#4db510]">Read Less</span>
                        ) : (
                          <span className="underline font-semibold text-[#4db510]">Read More</span>
                        )}
                      </span>
                    )}
                  </p>
                ...
                <div className="flex flex-row gap-2 mt-4">
                  ...
                  >
                    <div className="bg-white hover:scale-105 rounded-full justify-center items-center flex p-[2px]">👏</div>
                    <div className="rounded-full justify-center items-center flex p-[2px] w-4">{comment.clap}</div>
                  </div>
                  ...
                  >
                    <div className="bg-white hover:scale-105 rounded-full justify-center items-center flex p-[2px]">❤️</div>
                    <div className="rounded-full justify-center items-center flex p-[2px] w-4">{comment.heart}</div>
                  </div>
                  ...
                  >
                    <div className="bg-white hover:scale-105 rounded-full justify-center items-center flex p-[2px]">😂</div>
                    <div className="rounded-full justify-center items-center flex p-[2px] w-4">{comment.tears_of_joy}</div>
                  </div>
                </div>
              </div>
            ))}
